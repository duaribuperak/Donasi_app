...
<!-- component -->
<div class="flex justify-center items-center w-screen min-h-screen bg-white pt-12">
	<!-- COMPONENT CODE -->
	<div class="container mx-auto px-4 lg:px-20">

		<div class=" w-full mx-auto p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
			<div class="flex">
				<h1 class="font-bold text-5xl text-black">Kirim-Kirim</h1>
			</div>
            ...
            <div class="dropdown">
              <div tabindex="0" role="button" class="btn  w-full bg-gray-100 text-gray-400 mt-2 p-3 border-none text-left  hover:bg-gray-100">payment</div>
				...
				<div class="my-2 min-w-full lg:w-1/4 ">
					<button class="text-lg font-bold tracking-wide bg-blue-900 text-gray-100 p-3 rounded-lg w-full 
