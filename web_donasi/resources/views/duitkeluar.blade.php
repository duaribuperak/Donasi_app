...
<div class="flex justify-center py-28  ">
  <a href="#" class="block p-12 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-600  dark:hover:bg-gray-800 cursor-pointer-none">
    ...
    <p class="font-normal text-gray-100 ">total Pengeluaran untuk User lain</p>
  </a>
...
<!-- input search -->
<div class="mb-3 ml-4">
    <div class="relative mb-4 flex w-72 flex-wrap items-stretch">
      <input
      type="search"
    ...
    <thead class="">
      <tr class=" bg-slate-100">
        ...
        <th class="border-y border-blue-gray-100 bg-blue-gray-50/50 p-4 transition-colors hover:bg-blue-gray-50 border-r">
          <p class="text-black font-medium antialiased font-sans text-sm text-blue-gray-900 flex items-center justify-between gap-2 leading-none opacity-70">Untuk 
          </p>
        </th>
    ...
    <tbody>
      ...
      <tr class="">
        ...
        <td class="p-4 border-b border-blue-gray-50 border-r">
          <div class="flex items-center gap-3">
            ...
            <div class="flex flex-col">
              <p class="text-black block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-normal">{{ $history->toUser->nama }}</p>
              <p class="block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-normal text-slate-500">{{ $history->toUser->email }}</p>
            </div>
          </div>
        </td>
        ...
        <td class="p-4 border-b border-blue-gray-50">
          ...
          <!-- button delete -->
          <form action="/duitkeluar" method="post">
            @csrf
            @method('DELETE')
            <input type="hidden" name="id" value="{{ $history->id }}">
            <button class="relative align-middle select-none font-sans font-medium text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none w-10 max-w-[40px] h-10 max-h-[40px] rounded-lg text-xs text-blue-gray-500 hover:bg-blue-gray-500/10 active:bg-blue-gray-500/30" type="submit" onclick="return alert('apakah anda yakin ingin menghapus?')">
              <span class="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2">
